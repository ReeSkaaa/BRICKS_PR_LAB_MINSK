...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initializePanel() {
    ...
    navPill.style.zIndex = '1000'; // Высокий приоритет когда панель закрыта
  ...
  function showPanel() {
    ...
    navPill.style.zIndex = '1001'; // Еще выше когда панель открыта
    navPanel.style.zIndex = '1000'; // Панель под кнопкой
  }

  function hidePanel() {
    navPanel.classList.add('hidden');
    navPill.classList.remove('active');
    navPill.style.zIndex = '1000'; // Возвращаем высокий приоритет
  }
