...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const PLACES = [
    { 
      id: 'mez_mol_sot_7', 
      title: 'Красноярский молодёжный форум', 
      cat: 'restaurant', 
      ...
      desc: 'Красноярский молодежный форум объединил 200 представителей молодежи из 7 регионов России и 5 стран мира. За время форума участники не только получили знания от федеральных и региональных экспертов, но выполняли задания в командах на всех площадках и разрабатывали собственные проекты.',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Инициализация - скрываем панель при загрузке
  function initializePanel() {
    navPanel.classList.add('hidden');
    navPill.style.opacity = '1';
    navPill.style.visibility = 'visible';
    navPill.style.zIndex = '1000';
  ...
  function showPanel() {
    ...
    navPill.style.opacity = '0'; // Исчезает при открытии панели
  ...
  function hidePanel() {
    navPanel.classList.add('hidden');
    navPill.classList.remove('active');
    navPill.style.opacity = '1'; // Появляется при закрытии панели
    navPill.style.visibility = 'visible';
    navPill.style.zIndex = '1000';
  }
  ...
  // Скрыть панель при нажатии на кнопку назад в панели
